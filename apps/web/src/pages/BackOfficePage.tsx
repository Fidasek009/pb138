		...
		<div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
			...
			<main className="mx-auto max-w-7xl space-y-8 p-8">
				...
				<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
					...
					<Card>
						<CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
							<CardTitle className="font-medium text-sm">OpenAI API</CardTitle>
							...
							<table className="w-full text-left text-sm text-zinc-500 dark:text-zinc-400">
								...
								<tbody>
									<tr className="border-zinc-200 border-b bg-white hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950 dark:hover:bg-zinc-900">
										...
										<td className="px-6 py-4">Platform Default</td>
										<td className="px-6 py-4">120K / 500K</td>
									...
									<tr className="border-zinc-200 border-b bg-white hover:bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-950 dark:hover:bg-zinc-900">
										...
										<td className="px-6 py-4">Custom API Key</td>
